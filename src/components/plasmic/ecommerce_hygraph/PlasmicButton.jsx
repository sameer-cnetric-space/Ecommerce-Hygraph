...
import sty from "./PlasmicButton.module.css"; // plasmic-import: bN83BFeysHB/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: VMTaClL0vvr/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: -bnKd_wqi8p/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__wlJmw)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__e9J6A)}
                role={"img"}
              />
            ),
